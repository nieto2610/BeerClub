...
public class EventPromotionController {
    ...
    @GetMapping("/filter")
    public List<EventPromotionDTO> filterEvents(@ModelAttribute EventPromotionFilterDTO eventPromotionFilterDTO) {
        return eventPromotionService.filterEventPromotion(eventPromotionFilterDTO);
    }
